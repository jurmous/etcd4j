package com.inscriptive.etcd4j.responses;
...
public class EtcdKeysResponseParserTest {
  ...
  public void testParseSetKey() throws Exception {
    EtcdKeysResponse action = EtcdKeysResponseParser.parse(Unpooled.copiedBuffer(("{\n" +
        "    \"action\": \"set\",\n" +
        "    \"node\": {\n" +
        "        \"createdIndex\": 2,\n" +
        "        \"key\": \"/message\",\n" +
  ...
  public void testParseSetKeyTtl() throws Exception {
    ...
    assertEquals(EtcdKeysResponseParser.convertDate("2013-12-04T12:01:21.874888581-08:00"), action.node.expiration);
  }

  @Test
  public void testParseTtlExpiredException() throws Exception {
    try {
      EtcdKeysResponseParser.parse(Unpooled.copiedBuffer(("{\n" +
          "    \"cause\": \"/foo\",\n" +
          "    \"errorCode\": 100,\n" +
          "    \"index\": 6,\n" +
  ...
  public void testParseUpdateKeyTtl() throws Exception {
    ...
    assertEquals(EtcdKeysResponseParser.convertDate("2013-12-04T12:01:21.874888581-08:00"), action.prevNode.expiration);
  }
  ...
  public void testParseExpiredDir() throws Exception {
    ...
    assertEquals(EtcdKeysResponseParser.convertDate("2013-12-11T10:39:35.689275857-08:00"), action.prevNode.expiration);
